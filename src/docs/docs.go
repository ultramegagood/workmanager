...
const docTemplate = `{
            ...
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/response.SuccessWithData-model_Group"
                        }
                    },
                    "400": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/response.SuccessWithData-[]uuid_UUID"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
    ...
    "definitions": {
        ...
        "response.SuccessWithData-[]uuid_UUID": {
            "type": "object",
            "properties": {
                "code": {
                    "type": "integer"
        ...
        "response.SuccessWithData-model_Group": {
            "type": "object",
            "properties": {
                "code": {
                    "type": "integer"
